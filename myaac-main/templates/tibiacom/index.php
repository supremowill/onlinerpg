...
<body onBeforeUnLoad="SaveMenu();" onUnload="SaveMenu();">
  ...
  <div id="top"></div>
  <?php 
    $bg_file = $template_path . '/images/header/' . $config['background_image'];
    $bg_version = file_exists($bg_file) ? '?v=' . filemtime($bg_file) : '';
  ?>
  <div id="ArtworkHelper" style="background-image:url(<?php echo $bg_file . $bg_version; ?>);" >
      ...
      <div id="ContentRow">
        <div id="MenuColumn">
          <div id="LeftArtwork">
            ...
            <?php 
              $logo_file = $template_path . '/images/header/' . $config['logo_image'];
              $logo_version = file_exists($logo_file) ? '?v=' . filemtime($logo_file) : '';
            ?>
            <img id="TibiaLogoArtworkTop" src="<?php echo $logo_file . $logo_version; ?>" onClick="window.location = '<?php echo getLink('news')?>';" alt="logoartwork" />
