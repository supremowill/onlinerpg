...
exports.BombardeiroInsanoEnemy = exports.MestraDaIlusaoEnemy = exports.BruxaDoGeloEnemy = void 0;
const Enemy_1 = require("./Enemy");
const config_1 = require("../../config");
/** BruxaDoGelo - Ice Witch: freezing cone, blizzard AoE, ice wall (slow), immunity to freeze */
class BruxaDoGeloEnemy extends Enemy_1.ServerEnemy {
    freezingConeCooldown = 8000;
    lastFreezingCone = 0;
    blizzardCooldown = 15000;
    lastBlizzard = 0;
    iceWallCooldown = 20000;
    lastIceWall = 0;
    pendingAbilities = [];
    pendingProjectiles = [];
    constructor(pos, globalMultiplier) {
        ...
        const c = config_1.CONFIG.BRUXA_DO_GELO;
...
exports.BruxaDoGeloEnemy = BruxaDoGeloEnemy;
/** MestraDaIlusao - Illusion Mistress */
class MestraDaIlusaoEnemy extends Enemy_1.ServerEnemy {
    habilidades = {
        h1: { cooldown: 6000, lastUsed: 0, state: 'idle', startPos: null, returnTimer: 0 },
        h2: { cooldown: 10000, lastUsed: 0, state: 'idle', linkTimer: 0, target: null },
    ...
    constructor(pos, globalMultiplier) {
        ...
        const c = config_1.CONFIG.MESTRA_DA_ILUSAO;
        this.maxHp = c.BASE_HP * globalMultiplier;
        this.hp = this.maxHp;
        this.speed = c.SPEED;
        this.originalSpeed = c.SPEED;
    ...
    update(dt, players, gameTime) {
        ...
        if (now > h2.lastUsed + h2.cooldown && dist < 12 && h2.state === 'idle') {
            ...
            const dashDir = target.position.clone().sub(this.position);
            dashDir.y = 0;
            dashDir.normalize();
...
exports.MestraDaIlusaoEnemy = MestraDaIlusaoEnemy;
/** BombardeiroInsano - Insane Bomber: bouncing bombs, mine field, armor fracture, burn */
class BombardeiroInsanoEnemy extends Enemy_1.ServerEnemy {
    bouncingBombCooldown = 5000;
    lastBouncingBomb = 0;
    mineFieldCooldown = 20000;
    lastMineField = 0;
    armorFractureCooldown = 12000;
    lastArmorFracture = 0;
    attackCooldown = 3000;
    lastAttack = 0;
    pendingAbilities = [];
    ...
    constructor(pos, globalMultiplier) {
        ...
        const c = config_1.CONFIG.BOMBARDEIRO_INSANO;
        this.maxHp = c.BASE_HP * globalMultiplier;
        this.hp = this.maxHp;
        this.speed = c.SPEED;
        this.originalSpeed = c.SPEED;
...
exports.BombardeiroInsanoEnemy = BombardeiroInsanoEnemy;
